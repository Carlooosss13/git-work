...
***Nombre:*** Rodrigo García Delgado y Carlos Estévez González [1]
***Curso:*** 2º de Ciclo Superior de Desarrollo de Aplicaciones Web. [1]
...
```
La terminal arrojará el siguiente aviso de error:
...
Siguiendo las instrucciones de la práctica, User 1 elimina los marcadores
